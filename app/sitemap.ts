...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const pages: { route: string; date: string; priority: number }[] = [
    ...
    { route: "/roof-pitch-calculator", date: "2026-07-20", priority: 0.9 },
    { route: "/unit-converter", date: "2026-06-02", priority: 0.8 },
    { route: "/guides", date: "2026-06-29", priority: 0.8 },
    {
      route: "/guides/how-to-calculate-concrete-volume",
      date: "2026-06-12",
      priority: 0.7,
    },
    {
      route: "/guides/cubic-yards-to-cubic-meters",
      date: "2026-06-12",
      priority: 0.7,
    },
    {
      route: "/guides/tile-grout-gap-guide",
      date: "2026-06-12",
      priority: 0.7,
    },
    {
      route: "/guides/concrete-strength-grades",
      date: "2026-06-12",
      priority: 0.7,
    },
    {
    ...
    {
      route: "/guides/what-size-rebar-do-i-need",
      date: "2026-06-12",
      priority: 0.7,
    },
    {
      route: "/guides/how-to-calculate-paint-coverage",
      date: "2026-06-15",
      priority: 0.7,
    },
    {
      route: "/guides/how-to-calculate-wall-area-for-painting",
      date: "2026-06-21",
      priority: 0.7,
    },
    {
      route: "/guides/how-many-bricks-per-square-metre",
      date: "2026-06-16",
      priority: 0.7,
    },
    {
    ...
    {
      route: "/guides/standard-brick-sizes-by-country",
      date: "2026-06-16",
      priority: 0.7,
    },
    {
      route: "/guides/how-to-calculate-bricks-for-a-wall",
      date: "2026-06-18",
      priority: 0.7,
    },
    {
      route: "/guides/single-vs-double-leaf-brick-wall",
      date: "2026-06-18",
      priority: 0.7,
    },
    {
      route: "/guides/how-to-calculate-fence-post-spacing",
      date: "2026-06-25",
      priority: 0.7,
    },
    {
      route: "/guides/concrete-curing-time-guide",
      date: "2026-06-25",
      priority: 0.7,
    },
    {
      route: "/guides/how-to-lay-tile-step-by-step",
      date: "2026-06-25",
      priority: 0.7,
    },
    {
      route: "/guides/how-much-mulch-do-i-need",
      date: "2026-06-29",
      priority: 0.7,
    },
    {
      route: "/guides/how-to-calculate-mulch",
      date: "2026-06-29",
      priority: 0.7,
    },
    {
      route: "/guides/how-to-calculate-stair-rise-and-run",
      date: "2026-07-07",
      priority: 0.7,
    },
    {
    ...
    {
      route: "/guides/how-to-calculate-drywall-sheets",
      date: "2026-07-14",
      priority: 0.7,
    },
    {
      route: "/guides/drywall-screw-spacing-guide",
      date: "2026-07-15",
      priority: 0.7,
    },
    {
      route: "/guides/how-to-calculate-roof-pitch",
      date: "2026-07-21",
      priority: 0.7,
    },
    {
      route: "/guides/roof-pitch-to-degrees-conversion",
      date: "2026-07-22",
      priority: 0.7,
    },
